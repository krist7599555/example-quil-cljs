...
var vec__6061 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6061,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6061,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6061,(2),null);
var vec__6064 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6064,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6064,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6064,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__6067,p__6068){
var vec__6069 = p__6067;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6069,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6069,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6069,(2),null);
var vec__6072 = p__6068;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6072,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6072,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6072,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__6075_SHARP_){
return (p1__6075_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__6076_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__6077_SHARP_,angle_lr),angle_ud);
...
var map__6079 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__6079__$1 = (((((!((map__6079 == null))))?(((((map__6079.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6079.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6079):map__6079);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6079__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6079__$1,cljs.core.cst$kw$straight);
var temp__5733__auto__ = (function (){var pred__6081 = cljs.core._EQ_;
var expr__6082 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__6084 = cljs.core.cst$kw$w;
var G__6085 = expr__6082;
return (pred__6081.cljs$core$IFn$_invoke$arity$2 ? pred__6081.cljs$core$IFn$_invoke$arity$2(G__6084,G__6085) : pred__6081.call(null,G__6084,G__6085));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__6086 = cljs.core.cst$kw$s;
var G__6087 = expr__6082;
return (pred__6081.cljs$core$IFn$_invoke$arity$2 ? pred__6081.cljs$core$IFn$_invoke$arity$2(G__6086,G__6087) : pred__6081.call(null,G__6086,G__6087));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__6081.cljs$core$IFn$_invoke$arity$2 ? pred__6081.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__6082) : pred__6081.call(null,quil.middlewares.navigation_3d.space,expr__6082)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__6088 = cljs.core.cst$kw$z;
var G__6089 = expr__6082;
return (pred__6081.cljs$core$IFn$_invoke$arity$2 ? pred__6081.cljs$core$IFn$_invoke$arity$2(G__6088,G__6089) : pred__6081.call(null,G__6088,G__6089));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__6090 = cljs.core.cst$kw$d;
var G__6091 = expr__6082;
return (pred__6081.cljs$core$IFn$_invoke$arity$2 ? pred__6081.cljs$core$IFn$_invoke$arity$2(G__6090,G__6091) : pred__6081.call(null,G__6090,G__6091));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__6092 = cljs.core.cst$kw$a;
var G__6093 = expr__6082;
return (pred__6081.cljs$core$IFn$_invoke$arity$2 ? pred__6081.cljs$core$IFn$_invoke$arity$2(G__6092,G__6093) : pred__6081.call(null,G__6092,G__6093));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5733__auto__,map__6079,map__6079__$1,up,straight){
return (function (p1__6078_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__6078_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5733__auto__,map__6079,map__6079__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6094_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__6095 = options;
var G__6096 = ((function (G__6095,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__6095,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__6095,G__6096) : rotate_on.call(null,G__6095,G__6096));
})();
...
var map__6097_6112 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__6097_6113__$1 = (((((!((map__6097_6112 == null))))?(((((map__6097_6112.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6097_6112.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6097_6112):map__6097_6112);
var vec__6098_6114 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6097_6113__$1,cljs.core.cst$kw$straight);
var c_x_6115 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6098_6114,(0),null);
var c_y_6116 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6098_6114,(1),null);
var c_z_6117 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6098_6114,(2),null);
var vec__6101_6118 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6097_6113__$1,cljs.core.cst$kw$up);
var u_x_6119 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6101_6118,(0),null);
var u_y_6120 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6101_6118,(1),null);
var u_z_6121 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6101_6118,(2),null);
var vec__6104_6122 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6097_6113__$1,cljs.core.cst$kw$position);
var p_x_6123 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6104_6122,(0),null);
var p_y_6124 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6104_6122,(1),null);
var p_z_6125 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6104_6122,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_6123,p_y_6124,p_z_6125,(p_x_6123 + c_x_6115),(p_y_6124 + c_y_6116),(p_z_6125 + c_z_6117),u_x_6119,u_y_6120,u_z_6121);
...
var G__6108 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__6109 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__6108,G__6109) : key_pressed.call(null,G__6108,G__6109));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__6110 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__6111 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__6110,G__6111) : rotate_on_fn.call(null,G__6110,G__6111));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
