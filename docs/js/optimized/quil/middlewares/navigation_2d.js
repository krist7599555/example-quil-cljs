...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6621_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_6622 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_6623 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_6622);
var pos_6624 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_6622);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_6623);

var tr__6525__auto___6625 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_6623) - cljs.core.first(pos_6624)),(((quil.core.height() / (2)) / zoom_6623) - cljs.core.second(pos_6624))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__6525__auto___6625);
...
var G__6626 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__6627 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__6626,G__6627) : user_mouse_dragged.call(null,G__6626,G__6627));
...
return (function (state,event){
var G__6628 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__6629 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__6628,G__6629) : user_mouse_wheel.call(null,G__6628,G__6629));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
